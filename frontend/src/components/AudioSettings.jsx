          ...
          >
            <div className="panel-header">
              <h2 id="audio-settings-title">
                <span aria-hidden="true">🔊</span> Audio Settings
              </h2>
              <button
                type="button"
                className="close-btn"
            ...
            <div className="settings-list">
              ...
              >
                <div className="setting-info">
                  <span className="setting-label" id="master-volume-label">
                    Master Volume
                  </span>
                  <span className="setting-value" aria-live="polite" aria-atomic="true">
            ...
            <div className="panel-footer">
              ...
              <button
                ...
                onClick={onClose}
                title="Save and close audio settings"
              >
                Done
              </button>
            </div>
